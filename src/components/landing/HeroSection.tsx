...
export function HeroSection() {
  const { user } = useAuth();
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-[#F9FAFB] dark:bg-[#0D0F12]">
      {/* Background Gradients */}
      <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-blue-500/20 dark:bg-blue-600/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-indigo-500/20 dark:bg-indigo-600/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10 flex flex-col items-center text-center">
        ...
        <motion.h1 
          ...
          className="text-6xl md:text-8xl font-heading font-black tracking-tighter text-slate-900 dark:text-white mb-8 leading-[1.05]"
        >
        ...
        <motion.p 
          ...
          className="text-xl md:text-2xl text-slate-600 dark:text-slate-400 max-w-2xl mb-12 font-medium leading-relaxed"
        >
          Tell us what you want to learn. Our AI builds a comprehensive, structured journey tailored to your exact needs in seconds.
        </motion.p>
      ...
      {/* Decorative Floating Elements can go here later */}
    </section>
  );
}
